...
<head>
    ...
    <title>Pharmacia: Employees</title>
    ...
    <main>
                        ...
                        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item active" href="employee-view.php">Manage Employees</a></li>
                                </ul>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
        ...
        <div class="container text-center">
            ...
            echo "<tr>";
                ...
                echo "<td>";
                echo "<a class='btn btn-info mx-1' href=employee-update.php?id=".$row['e_id'].">Edit</a>";
                echo "<a onclick='return confirm('Are you sure to delete?');' class='btn btn-danger mx-1' href=employee-delete.php?id=".$row['e_id'].">Delete</a>";
                echo "</td>";
            echo "</tr>";
            }
            echo "</table>";
