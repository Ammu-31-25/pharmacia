...
<head>
    ...
    <title>Pharmacia: Employees- Add</title>
...
<body>
    ...
    <main>
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item active" href="employee-add.php">Add New Employee</a></li>
        ...
        <div class="container my-5 vh-80">
            <p class="lead">ADD EMPLOYEE DETAILS</p>
        </div>
        <div class="container">
            <?php
	...
	?>
            <form action="<?=$_SERVER['PHP_SELF']?>" method="post">
                <div class="container bg-auto">
                    <div class="d-flex">
                        <div class="col-6 m-1 p-1"><label for="eid">Employee ID:</label><br><input type="number" name="eid" class="form-control"></div>
                        <div class="col-6 m-1 p-1"><label for="efname">First Name:</label><br><input type="text" name="efname" class="form-control"></div>
                    </div>
                    <div class="d-flex">
                        <div class="col-6 m-1 p-1"><label for="elname">Last Name:</label><br><input type="text" name="elname" class="form-control"></div>
                        <div class="col-6 m-1 p-1"><label for="ebdate">Date of Birth:</label><br><input type="date" name="ebdate" class="form-control"></div>
                    </div>
                    <div class="d-flex">
                        <div class="col-6 m-1 p-1"><label for="eage">Age:</label><br><input type="number" name="eage" class="form-control"></div>
                        <div class="col-6 m-1 p-1"><label for="esex">Gender:</label><br>
                        <select name="esex" id="esex" class="form-select">
                    ...
                    <div class="d-flex">
                        <div class="col-6 m-1 p-1"><label for="etype">Employee Type:</label><br><select id="etype" name="etype" class="form-select">
							<option value="selected">Select</option>
								<option>Pharmacist</option>
								<option>Manager</option>
						</select></div>
                        <div class="col-6 m-1 p-1"><label for="ejdate">Date of Joining:</label><input type="date" name="ejdate" class="form-control"></div>
                    </div>
                    <div class="d-flex">
                        <div class="col-6 m-1 p-1"><label for="esal">Salary:</label><br><input type="number" step="0.01" name="esal" class="form-control"></div>
                        <div class="col-6 m-1 p-1"><label for="ephno">Phone Number:</label><br><input type="number" name="ephno" placeholder="###-###-####" class="form-control"></div>
                    </div>
                    <div class="d-flex">
                        <div class="col-6 m-1 p-1"><label for="e_mail">Email ID:</label><br><input type="email" name="e_mail" placeholder="someone@example.com" class="form-control"></div>
                        <div class="col-6 m-1 p-1"><label for="eadd">Address</label><input type="text" name="eadd" class="form-control"></div>
                    </div>
                    <div class="col-12 m-4 p-1 text-center"><input type="submit" name="add" value="Add Employee"
