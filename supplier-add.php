...
<head>
    ...
    <title>Pharmacia: Supplier Management- Add</title>
...
<body>
    ...
    <main>
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item active" href="supplier-add.php">Add New Supplier</a></li>
        ...
        <div class="container my-5 vh-80">
            <p class="lead">ADD SUPPLIER DETAILS</p>
        </div>
        <div class="container">
                 ...
                 <div class="container bg-auto">
                     ...
                     <div class="d-flex">
                         <div class="col-6 m-1 p-1">
                             ...
                             <input type="number" class="form-control" placeholder="ID" name="sid" required>
                         </div>
                         <div class="col-6 m-1 p-1">
                     ...
                     <div class="d-flex mb-3">
                         <div class="col-6 m-1 p-1">
                             ...
                             <input type="text" name="sadd" class="form-control" placeholder="" required>
                         </div>
                         <div class="col-6 m-1 p-1">
                            <label for="sphno">Phone Number</label>
                            <input type="number" name="sphno" class="form-control" placeholder="###-###-####" required>
                        </div>
                     </div>
                     <!-- Third Row -->
                     <div class="d-flex">
                         ...
                         <div class="col-6 m-1 p-1">
                             ...
                             <input type="email" name="smail" class="form-control" placeholder="someone@example.com">
                         </div>
                     </div>
                     <div class="d-flex">
