...
<head>
    ...
    <title>Pharmacia: Customers</title>
                        ...
                        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item active" href="customer-view.php">Manage Customers</a></li>
                                </ul>
                            </li>
                            <li class="nav-item">
        ...
        <div class="container text-center">
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<tr>";
                    ...
                    echo "<td>";
                        echo "<a class='btn btn-info mx-1' href=customer-update.php?id=".$row['c_id'].">Edit</a>";
                        echo "<a class='btn btn-danger mx-1' href=customer-delete.php?id=".$row['c_id'].">Delete</a>";
                    echo "</td>";
                echo "</tr>";
                }
            echo "</table>";
