...
<head>
    ...
    <title>Pharmacia: Point of Sale</title>
...
<body>
                ...
                <div class="offcanvas offcanvas-start text-bg-auto" tabindex="-1" id="offcanvasNavbarDark"
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="pos1.php">Add New Sale</a>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
                                    aria-expanded="false">
        ...
        <div class="container">
            <div class="container text-center">
                ...
                <select id="cid" name="cid" class="form-select">
                    <option value="0" selected="selected">*Select Customer ID (only once for a customer's sales)
                    </option>
            ...
            ?>
                ...
                &nbsp;&nbsp;
                <input type="submit" name="custadd" value="Add to Proceed." class="btn btn-primary m-2">
            </form></div>
	...
	?>
        ...
        ?>
                    ...
                    &nbsp;&nbsp;
                    <input type="submit" name="search" class="btn btn-primary m-2" value="Search">
                </form>
            </div>
            <div class="container-fluid">
                <form method="post">
                    <div class="d-flex">
                        <div class="col-4 m-1 p-1"><label for="medid">Medicine ID:</label><br><input type="number" name="medid" value="<?php echo $row4[0]; ?>" readonly class="form-control"></div>
                        <div class="col-4 m-1 p-1"><label for="mdname">Medicine Name:</label><br><input type="text" name="mdname" value="<?php echo $row4[1]; ?>" readonly class="form-control"></div>
                        <div class="col-4 m-1 p-1"><label for="mcat">Category:</label><br><input type="text" name="mcat" value="<?php echo $row4[3]; ?>" readonly class="form-control"></div>
                    </div>
                    <div class="d-flex">
                        <div class="col-4 m-1 p-1"><label for="mloc">Location:</label><br><input type="text" name="mloc" value="<?php echo $row4[5]; ?>" readonly class="form-control"></div>
                        <div class="col-4 m-1 p-1"><label for="mqty">Quantity Available:</label><br><input type="number" name="mqty" value="<?php echo $row4[2]; ?>" readonly class="form-control"></div>
                        <div class="col-4 m-1 p-1"><label for="mprice">Price of One Unit:</label><br><input type="number" name="mprice" value="<?php echo $row4[4]; ?>" readonly class="form-control"></div>
                    </div>
                    <div class="d-flex">
                        <div class="col-4 m-1 p-1"><label for="mcqty">Quantity Required:</label><br><input type="number" name="mcqty" class="form-control"></div>
                        <div class="col-8 m-1 p-1 text-center"><input type="submit" name="add" value="Add Medicine" class="btn btn-primary"></div>
                    </div>
                    <?php
