...
<head>
    ...
    <title>Pharmacia: Inventory Managment</title>
...
<body>
    ...
    <main>
                        ...
                        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item active" href="inventory-view.php">Manage Inventory</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="nav-item dropdown">
        ...
        <div class="container my-5 vh-80">
            <p class="lead">MEDICINE INVENTORY</p>
        </div>
            ...
            <table id="table1" width="100%">
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<a class='btn btn-success mx-1' href=inventory-update.php?id=" . $row['med_id'] . ">Edit</a>";

                        echo "<a class='btn btn-danger mx-1' href=inventory-delete.php?id=" . $row['med_id'] . ">Delete</a>";
