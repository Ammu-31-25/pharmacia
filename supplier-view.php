...
<head>
    ...
    <title>Pharmacia: Supplier Management</title>
    ...
    <main>
                        ...
                        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item active" href="supplier-view.php">Manage Suppliers</a></li>
                                </ul>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
        ...
        <div class="container text-center">
            ...
            echo "<tr>";
                ...
                echo "<td>";
                echo "<a class='btn btn-success mx-1' href=supplier-update.php?id=".$row['sup_id'].">Edit</a>";
                echo "<a class='btn btn-danger mx-1' href=supplier-delete.php?id=".$row['sup_id'].">Delete</a>";
                echo "</td>";
            echo "</tr>";
            }
            echo "</table>";
