...
<head>
    ...
    <title>Pharmacia: Dashboard</title>
    ...
    <main>
        ...
        <nav class="navbar navbar-light bg-primary" style="background-color:#003366;"
            ...
            <div class="container-fluid">
                ...
                <a href="logout.php" style="text-decoration: none;color:azure;" class="lead">Logout</a>
                ...
                <div class="offcanvas offcanvas-start text-bg-auto" tabindex="-1" id="offcanvasNavbarDark"
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="pharmmainpage.php">Dashboard</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="pharm-inventory.php">View Inventory</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="pharm-pos1.php">Add New Sale</a>
                            </li>
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="pharm-customer.php">Add New Customer</a></li>
                                    <li><a class="dropdown-item" href="pharm-customer-view.php">Manage Customers</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="container text-center">
                <div class="row text-center">
                    <div class="col d-flex justify-content-center align-items-center">
                        <a href="pharm-pos1.php" data-toggle="tooltip" data-placement="top" title="Add new Sale" >
                    ...
                    <div class="col d-flex justify-content-center align-items-center">
                        <a href="pharm-inventory.php" data-toggle="tooltip" data-placement="top" title="View Inventory">
                        <div class="card p-4 m-4 shadow rounded-4 btn" style="width: 18rem;">
