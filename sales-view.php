...
<head>
    ...
    <title>Pharmacia: Sales Invoice Details</title>
...
<body>
    ...
    <main>
                ...
                <div class="offcanvas offcanvas-start text-bg-auto" tabindex="-1" id="offcanvasNavbarDark" aria-labelledby="offcanvasNavbarDarkLabel">
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="sales-view.php">View Sales Invoice Details</a>
                            </li>
                            <li class="nav-item">
        ...
        <div class="container my-5 vh-80">
            <p class="lead">SALES INVOICE DETAILS</p>
        </div>
