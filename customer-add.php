...
<head>
    ...
    <title>Pharmacia: Customers- Add</title>
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item active" href="customer-add.php">Add New Customer</a></li>
        ...
        <div class="container">
            <form action="<?=$_SERVER['PHP_SELF']?>" method="post">
                <div class="container bg-auto">
                    <div class="d-flex">
                        <div class="col-6 m-1 p-1"><label for="cid">Customer ID:</label><br><input type="number" name="cid" class="form-control"></div>
                        <div class="col-6 m-1 p-1"><label for="cfname">First Name:</label><br><input type="text" name="cfname" class="form-control"></div>
                    </div>
                    <div class="d-flex">
                        <div class="col-6 m-1 p-1"><label for="clname">Last Name:</label><br><input type="text" name="clname" class="form-control"></div>
                        <div class="col-6 m-1 p-1"><label for="age">Age:</label><br><input type="number" name="age" class="form-control"></div>
                    </div>
                    <div class="d-flex">
                        <div class="col-6 m-1 p-1"><label for="sex">Gender:</label><br>
                        ...
                        <div class="col-6 m-1 p-1"><label for="phno">Phone Number:</label><br><input type="number" name="phno" placeholder="###-###-####" class="form-control"></div>
                    </div>
                    <div class="d-flex">
                        <div class="col-6 m-1 p-1"><label for="emid">Email ID:</label><br><input type="email" name="emid" placeholder="someone@example.com" class="form-control"></div>
                    </div>
                    <div class="col-12 m-4 p-1 text-center"><input type="submit" name="add" value="Add Customer"
